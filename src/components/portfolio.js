  ...
  <section className="py-5 text-center container">
    <div className="row py-lg-5">
      <div className="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
          <a href="#a" className="btn btn-primary my-2">Main call to action</a>
          <a href="#a" className="btn btn-secondary my-2">Secondary action</a>
        </p>
      </div>
    </div>
  </section>
      ...
      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div className="col">
          <div className="card shadow-sm">
            <img src={require('../img/choping.png')} alt=""/>
...
<footer className="text-muted py-5">
  <div className="container">
    ...
    <p className="mb-0">New to Bootstrap? <a href="#a">Visit the homepage</a> or read our <a href="../getting-started/introduction/">getting started guide</a>.</p>
  </div>
</footer>
        </>
      )
